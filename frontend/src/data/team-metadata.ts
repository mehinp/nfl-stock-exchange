...
export const teamMetadata: TeamMetadata[] = [
  ...
  { city: "Los Angeles", nickname: "Chargers", abbreviation: "LAC", division: "AFC West", aliases: ["SD", "San Diego Chargers"] },
  {
    ...
    abbreviation: "LAR",
    division: "NFC West",
    aliases: ["STL", "St. Louis Rams", "LA", "LA Rams", "Los Angeles Rams"],
  },
  ...
  {
    city: "AFC North",
    nickname: "Division ETF",
    abbreviation: "AFCN",
    division: "AFC North",
    aliases: ["AFC North ETF", "AFC North"],
  },
  {
    city: "AFC South",
    nickname: "Division ETF",
    abbreviation: "AFCS",
    division: "AFC South",
    aliases: ["AFC South ETF", "AFC South"],
  },
  {
    city: "AFC East",
    nickname: "Division ETF",
  ...
  },
  {
    ...
    abbreviation: "NFCN",
    division: "NFC North",
    aliases: ["NFC North ETF", "NFC North"],
  },
  {
    city: "NFC South",
    nickname: "Division ETF",
    abbreviation: "NFCS",
    division: "NFC South",
    aliases: ["NFC South ETF", "NFC South"],
  },
  {
    city: "NFC East",
    nickname: "Division ETF",
